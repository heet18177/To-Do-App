...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 p-4">
  ...
  <div class="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-md">
    ...
    <form action="signup.php" method="POST" class="space-y-5">
      ...
      <div>
        ...
        <div class="flex items-center border border-gray-300 rounded-lg px-3 py-2 focus-within:border-blue-500">
          <i class='bx bx-envelope text-gray-400 text-xl mr-2'></i>
      ...
      <button name="signup" type="submit"
        class="w-full bg-blue-600 hover:bg-blue-700 transition duration-300 text-white font-semibold py-3 rounded-lg shadow-lg">
        Sign Up
      </button>
    </form>
    ...
    <p class="text-center text-gray-600 mt-6">Already have an account? <a href="login.php" class="text-blue-600 font-medium hover:underline">Log in</a></p>
  </div>
